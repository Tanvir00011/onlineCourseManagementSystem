...
@section('body')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h1 class="card-title mb-4 text-left">Update Course Form</h1>

                    <form action="{{route('course.update', ['id' => $course->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="form-group row mb-4">
                            <label for="teacher_id" class="col-sm-3 col-form-label">Course Category <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row mb-4">
                            <label for="title" class="col-sm-3 col-form-label">Course Title <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="text" name="title" class="form-control" id="title" value="{{$course->title}}" placeholder="Course Title" required/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            <label for="starting_date" class="col-sm-3 col-form-label">Starting Date <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input type="date" name="starting_date" class="form-control" id="starting_date" value="{{$course->starting_date}}" required>
                            </div>
                        </div>
